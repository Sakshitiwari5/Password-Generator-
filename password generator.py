...
root.title("Sakshi Password Generator")
...
Title = Label(root, text="Sakshi Password Generator", bg="violet", fg="black", font=("futura", 15, "bold"))
Title.pack(anchor="center", pady="20px")

length = Label(root, text="Select the Length of Your Password :- ", fg="darkblue", bg="violet", font=("ubuntu", 12))
...
generate_btn = Button(root, text="Generate Password", bg="blue", fg="black", font=("ubuntu", 15), cursor="hand2", command=password_generate)
generate_btn.bind("<Enter>", on_enter)
generate_btn.bind("<Leave>", on_leave)
generate_btn.pack(anchor="center", pady="50px")

result_lable = Label(root, text="Generated Password Here :- ", bg="red", fg="darkgreen", font=("ubuntu", 12))
